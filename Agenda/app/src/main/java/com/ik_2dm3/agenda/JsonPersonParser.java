...
public class JsonPersonParser {
    ...
    public Persona leerPersona(JsonReader reader) throws IOException{
        String dni=null, telefono=null, nombre=null, mail=null;

        reader.beginObject();
        while(reader.hasNext()){
            /*nextName devuelve la clave del siguiente token como string...
            * Tambien tenemos nextInt...peek() nos devuelve el tipo de dato del siguiente elemento*/
